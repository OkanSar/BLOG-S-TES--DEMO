...
namespace DataAccessLayer.Concrete
{
    public class Context: IdentityDbContext<AppUser,AppRole,int>
    {
        ...
        {
            optionsBuilder.UseSqlServer("server = DESKTOP-6RH98V8;database=CoreBlogDb; Integrated security=true; TrustServerCertificate=True;");
        }
        ...
        public DbSet<Message> Teams { get; set; }
        public DbSet<Message> Matches { get; set; }
